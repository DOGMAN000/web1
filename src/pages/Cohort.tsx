...
import communityImage from "../assets/cohortCommunity.png";
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8 max-w-3xl mx-auto leading-relaxed">
              Discover the specific benefits and expectations of being a CSTC
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-gray-900 mb-6">
              What You Get as a CSTC Member
            </h2>
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Unlock exclusive resources, opportunities, and connections
              designed specifically for community college transfer students.
            </p>
          </div>
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Permanent access to the CSTC Slack workspace with
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Channels for technical help, interview prep, off-topic
                        chats, and regional meetups.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Connect with students who understand your unique
              ...
              <div data-aos="fade-up" data-aos-delay="400" className="bg-blue-50 rounded-2xl p-8 text-center">
                <img
                  src={communityImage}
                  alt="Community"
                  className="mx-auto w-160 h-80 mb-4 object-cover rounded-2xl"
                />
              ...
              <div data-aos="fade-up" data-aos-delay="200" className="order-1 lg:order-2">
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      <h4 className="font-semibold text-gray-900">
                        The CSTC Internship List
                      </h4>
                      <p className="text-gray-600">
                        A curated, live list of Summer 2026 internships and
                        research opportunities specifically for community
                        college students.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Exclusive access to roles at emerging startups looking
                        to hire CSTC members.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Get help with your transfer applications, resumes, and
                        cover letters from experienced mentors.
                      </p>
                    </div>
                  </li>
                </ul>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Intimate talks with engineers, founders, and recruiters
                  ...
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Take initiative by leading a project, organizing a
                        workshop, or becoming a mentor for future members.
                      </p>
                    </div>
                  </li>
                  <li className="flex items-start space-x-3">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">
                        Build meaningful relationships with professionals who
                        understand and value your transfer experience.
                      </p>
                    </div>
                  </li>
                </ul>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col lg:flex-row items-center gap-10 mb-16">
            ...
            <div className="lg:w-1/2 text-center lg:text-left space-y-6">
              ...
              <p className="text-xl text-gray-600 leading-relaxed">
                CSTC is designed for ambitious community college students ready
                to make their mark in technology. We focus on building skills,
                gaining mentorship, and connecting with a supportive tech
                community.
              </p>
            </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div data-aos="fade-up" data-aos-delay="0" className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600">
                You are currently enrolled at a community college in the United
                States and actively pursuing your education.
              </p>
            </div>
            ...
            <div data-aos="fade-up" data-aos-delay="200" className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600">
                You intend to transfer to a four-year university to major in
            ...
            <div data-aos="fade-up" data-aos-delay="400" className="bg-white rounded-xl shadow-lg p-8 text-center">
              ...
              <p className="text-gray-600">
                You are passionate about technology and eager to contribute to a
      ...
      <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-4xl font-bold text-white mb-6">
            Ready to Join the CSTC Community?
          </h2>
          <p className="text-xl text-blue-100 mb-8">
            Take the next step in your tech journey. Join hundreds of transfer
            students who are already thriving with CSTC support.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
            onClick={() => window.scrollTo(0, 0)}
